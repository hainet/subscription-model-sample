package com.hainet.merchant.alpha;
...
@RestController
@Slf4j
public class MerchantAlphaApplication {

    private final JdbcTemplate jdbcTemplate;

    private final RestTemplate restTemplate;

    public MerchantAlphaApplication(
    ...
    public static void main(String[] args) {
        SpringApplication.run(MerchantAlphaApplication.class, args);
    }
    ...
    public String process(@RequestBody final Job job) {
        ...
        restTemplate.postForObject(
                "/job/merchant-alpha",
                new FireworqMessage("http://Haines-MBP.elecom:8091", job.getCycle(), job),
                String.class
        );
